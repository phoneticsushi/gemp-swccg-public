...
/**
 * An effect to 'hit' a card and resets its forfeit value, and cause opponent to lose Force.
 */
public class HitCardResetForfeitAndOpponentLosesForceEffect extends AbstractSubActionEffect implements PreventableCardEffect {
    ...
    private HitCardResetForfeitAndOpponentLosesForceEffect _that;

    /**
     * Creates an effect to 'hit' a card, resets its forfeit value, and causes opponent to lose Force.
     ...
     */
    public HitCardResetForfeitAndOpponentLosesForceEffect(Action action, PhysicalCard cardHitAndReset, float resetValue, float forceLoss, PhysicalCard hitByCard, SwccgBuiltInCardBlueprint hitByPermanentWeapon, PhysicalCard cardFiringWeapon) {
        super(action);
