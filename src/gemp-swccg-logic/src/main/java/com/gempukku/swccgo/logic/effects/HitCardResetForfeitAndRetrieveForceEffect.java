...
/**
 * An effect to 'hit' a card and resets its forfeit value, and cause player to retrieve Force.
 */
public class HitCardResetForfeitAndRetrieveForceEffect extends AbstractSubActionEffect implements PreventableCardEffect {
    ...
    private HitCardResetForfeitAndRetrieveForceEffect _that;

    /**
     * Creates an effect to 'hit' a card, resets its forfeit value, and causes player to retrieve Force.
     ...
     */
    public HitCardResetForfeitAndRetrieveForceEffect(Action action, PhysicalCard cardHitAndReset, float resetValue, float amountToRetrieve, PhysicalCard hitByCard, SwccgBuiltInCardBlueprint hitByPermanentWeapon, PhysicalCard cardFiringWeapon) {
        super(action);
