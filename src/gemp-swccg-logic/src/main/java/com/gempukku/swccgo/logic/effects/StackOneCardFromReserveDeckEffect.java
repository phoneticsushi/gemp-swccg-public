 ...
 */
public class StackOneCardFromReserveDeckEffect extends AbstractStandardEffect {
     ...
     */
    public StackOneCardFromReserveDeckEffect(Action action, String playerId, PhysicalCard stackOn, boolean faceDown) {
        super(action);
        _playerId = playerId;
        _stackOn = stackOn;
        _faceDown = faceDown;
