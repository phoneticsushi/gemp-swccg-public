...
/**
 * An effect to 'hit' a card and causes it to not be able to be used to satisfy attrition.
 */
public class HitCardAndMayNotBeUsedToSatisfyAttritionEffect extends AbstractSubActionEffect implements PreventableCardEffect {
    ...
    private HitCardAndMayNotBeUsedToSatisfyAttritionEffect _that;
     ...
     */
    public HitCardAndMayNotBeUsedToSatisfyAttritionEffect(Action action, PhysicalCard cardHit, PhysicalCard hitByCard, SwccgBuiltInCardBlueprint hitByPermanentWeapon, PhysicalCard cardFiringWeapon) {
        super(action);
        _cardHit = cardHit;
