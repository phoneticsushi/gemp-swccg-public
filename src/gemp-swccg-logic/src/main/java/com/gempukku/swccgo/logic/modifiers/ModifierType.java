...
public enum ModifierType {
    ...
    SATISFIES_BATTLE_ORDER,
    SATISFIES_BATTLE_PLAN,
    FORCE_DRAIN_IMMUNE_TO_BATTLE_ORDER,
    FORCE_DRAIN_IMMUNE_TO_BATTLE_PLAN,
    ...
    // Attacks
    MAY_NOT_INITIATE_ATTACKS_AT_LOCATION, MAY_NOT_ATTACK, MAY_NOT_ATTACK_TARGET, MAY_NOT_BE_ATTACKED, MAY_ATTACK_TARGET, MAY_NOT_ATTACK_CHARACTERS_OWNED_BY_PLAYER,
    MAY_INITIATE_ATTACKS_AT_LOCATION, EATEN_BY_IS_PLACED_OUT_OF_PLAY, PARASITE_TARGET,
    NUM_ATTACK_DESTINY_DRAWS,

    // Attrition
    // Beezer Bowl 2025: Added for "immune to attrition > X" modifier
    ATTRITION, UNMODIFIABLE_ATTRITION,
    IMMUNITY_TO_ATTRITION_LESS_THAN, IMMUNITY_TO_ATTRITION_GREATER_THAN, IMMUNITY_TO_ATTRITION_OF_EXACTLY, IMMUNITY_TO_ATTRITION_CHANGE, LOSE_IMMUNITY_TO_ATTRITION, IMMUNITY_TO_ATTRITION_MAY_NOT_BE_CANCELED, IMMUNITY_TO_ATTRITION_LIMITED_TO_VALUE,
    ...
    MAY_TARGET_AT_ANY_EXTERIOR_SITE_ON_PLANET,
