...
public enum Keyword implements Filterable {
    ...
    MT_KRANA_SITE("Mt. Krana Site", false),
    ...
    SORCERY_TEST_0("Sorcery Test #0", false, true),
    SORCERY_TEST_1("Sorcery Test #1", false, true),
    SORCERY_TEST_2("Sorcery Test #2", false, true),
    SORCERY_TEST_3("Sorcery Test #3", false, true),
    SORCERY_TEST_4("Sorcery Test #4", false, true),
