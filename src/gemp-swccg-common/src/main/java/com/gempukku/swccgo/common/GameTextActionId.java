...
public enum GameTextActionId {
    ...
    BACK_TO_BASE__SEARCH_LOST_PILE(true),
    ...
    BACK_DOOR__DOWNLOAD_EZ_PZ(true),
    ...
    CORPORAL_BEEZER__UPLOAD_DEVICE(true),
    ...
    KNEESAA__UPLOAD_EWOK_GLIDER_OR_EWOK(true),
    KNEESAA__TAKE_CARD_INTO_HAND_FROM_LOST_PILE(true),
    ...
    LEAVE_IT_TO_BEEZER__UPLOAD_ENDOR_OR_MT_KRANA_BATTLEGROUND_SITE(true),  // Beezer Bowl 2025 - Card 38 Objective
    ...
    NIK_SANT__UPLOAD_STARFIGHTER_OR_VEHICLE(true),
    ...
    ONCE_THE_SUNSTAR_IS_MINE__DOWNLOAD_MT_THUNDERSTONE_SITE(true),
    ONCE_THE_SUNSTAR_IS_MINE__UPLOAD_MAKRIT_TEEBO_OR_SORCERER(true),
    ...
    SERGEANT_BEEZER_AND_SERGEANT_JUNKIN__DEPLOY_DEVICE_OR_WEAPON(true),
    ...
    HAN_DEPENDABLE_GENERAL__UPLOAD_CARD(true),
    HAN_DEPENDABLE_GENERAL__PLACE_DEVICES_IN_USED_PILE(false, true),
    ...
    EWOK_GLIDER__ONCE_PER_GAME_CHOICE(true, true),
    ...
    GORAXS_LAIR__DEPLOY_GORAX_AND_PILE_OF_BONES(false,true),
    GORAX_THE_GREAT_DEVOURER__RELOCATE_TO_ADJACENT_SITE(false,true),
    GORAX_THE_MIGHTY__STACK_CHARACTER_UNDER_PILE_OF_BONES(false, true), 
    GORAX_THE_GREAT_DEVOURER__STACK_CHARACTER_UNDER_PILE_OF_BONES(false, true), 
    ...
    MASTER_ZARRAK__UPLOAD_HANG_GLIDER_OR_MEDALLION(true, true),
    ...
    MORAG_SORCERESS__DOWNLOAD_SHADOWSTONE_STAFF_OR_DEPLOY_FROM_LOST_PILE(true, true),
    ...
    PAPLOO__UPLOAD_SPEEDER_BIKE(true, true),
    ...
    SERGEANT_JUNKIN__STEAL_A_BLASTER(true, true),
    ...
    ZARRAKS_HANG_GLIDER__SHIELD_ZARRAK(false, true),
    ZARRAKS_MEDALLION__RETOW_WITH_SEVEN_EXCLAMATION_POINTS_YOU_CAN_COUNT_EM(false, true),
    ...
    TWILIGHT_IS_UPON_US__UPLOAD_CARD(true, false, false, false, false, true),
