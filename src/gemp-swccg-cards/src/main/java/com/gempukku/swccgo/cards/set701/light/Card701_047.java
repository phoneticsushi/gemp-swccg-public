...
public class Card701_047 extends AbstractSite {
    public Card701_047() {
        ...
        setLocationLightSideGameText("When deployed, take Gorax, The Mighty and Pile Of Bones from outside your deck and deploy them here.");
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextLightSideRequiredAfterTriggers(String playerOnLightSideOfLocation, SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        ...
        // When deployed, automatically deploy Gorax and Pile Of Bones from outside game (Light Side only)
