...
public class Card701_006 extends AbstractAlien {
    public Card701_006() {
        ...
        setGameText("Deploys -1 to any Endor mountain site.  May 'fly' (landspeed = 2).  Permanent device is •Crystal Cloak (during battle, may target opponent's device or character weapon present at same site; draw destiny; if destiny = target's destiny number, target is lost). Immune to [Permanent Weapon] and attrition < 4.");
